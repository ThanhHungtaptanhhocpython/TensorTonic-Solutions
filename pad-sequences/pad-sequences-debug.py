...
if __name__ == "__main__":
    ...
    # Trường hợp không truyền max_len (tự động lấy theo chuỗi dài nhất là 3)
    print("Tự động lấy max_len:\n", pad_sequences(sequences, pad_value=-1))
    # Kết quả:
    # [[ 1  2  3]
    #  [ 4  5 -1]
    #  [ 6 -1 -1]]

    # Trường hợp cố định max_len = 4
    print("\nCố định max_len = 4:\n", pad_sequences(sequences, pad_value=0, max_len=4))